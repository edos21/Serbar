<?php
	...
	$registro=mysql_query("insert into escofactura(n_factura,filial,codigo,nombre_emp,mail,cedula,nombre,status,precio,fecha,n_presupuesto)
	...
	echo "<a href='/serbar/esco/facturacion/factura'>volver</a>";
?>