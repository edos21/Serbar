<?php
//consulta el presupuesto utilizando el formato usado por serbar
	include ("../../../conexion.php");
	$registro=mysql_query("select * from escopresupuesto where n_presupuesto='$_REQUEST[presupuesto]'",$conexion) or
	die("error en select: ".mysql_error());
	$regisservicio=mysql_query("select * from escoservicios where n_presupuesto='$_REQUEST[presupuesto]'",$conexion) or
	die("error en select: ".mysql_error());
	$subtotal=0;
?>
<!DOCTYPE html>
<html lang="es">
	<head>
		<meta charset="UTF-8" />
		<title>Consulta presupuesto - Presupuesto</title>
