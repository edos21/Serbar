<?php
	...
	$registro=mysql_query("update escojjpresupuesto set ciudad='$_REQUEST[ciudadn]', fecha='$_REQUEST[fechan]', rif='$_REQUEST[rifn]', nombre_emp='$_REQUEST[nombre_empn]', telefono='$_REQUEST[telefonon]', direccion='$_REQUEST[direccionn]', mail='$_REQUEST[mailn]', cedula='$_REQUEST[cedulan]', nombre='$_REQUEST[nombren]', status='$_REQUEST[statusn]', orden='$_REQUEST[ordenn]', impuesto='$_REQUEST[impueston]' where n_presupuesto='$_REQUEST[presupuesto]'",$conexion) or
