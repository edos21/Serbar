<?php
	...
	$registro=mysql_query("select * from escoresumen where fecha='$_REQUEST[fecha]'",$conexion) or
	die("error en select: ".mysql_error());
	echo "<table summary='resumen por fecha' border='1px'>
			<caption>Ficha resumen recepcion de servicio (Fecha)</caption>
			<thead>
				<tr>
