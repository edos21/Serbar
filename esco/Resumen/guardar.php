<?php
	...
	$registro=mysql_query("insert into escoresumen(nota, factura, fecha, cedula, nombre, origen, destino, producto, cantidad, sector, coordinador, observacion)
	...
	echo "<a href='/serbar/esco/resumen'>volver</a>";
?>