<?php
//consulta de los servicios tomando como filtro la cedula del operador que presto el servicio
	include ("../../conexion.php");
	$registro=mysql_query("select * from escosolicitud where cedula='$_REQUEST[cedula]'",$conexion) or
	die("error en select: ".mysql_error());
	$registro2=mysql_query("select * from escosolicitud where cedula='$_REQUEST[cedula]'",$conexion) or
	die("error en select: ".mysql_error());
?>
<!DOCTYPE html>
<html lang="es">
	<head>
		<meta charset="UTF-8" />
		<title>Consulta por Operador - Tabulador de Precios</title>
...
?>
	<table summary='consulta de servicio por operador' border='1px'>
			<label>Nombre del operador: <?php echo $re['nombre']?></label>
			<thead>
				<tr>
