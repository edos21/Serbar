<?php
	...
	$registro=mysql_query("insert into jjfactura(n_factura,ciudad,rif,nombre_emp,direccion,telefono,mail,cedula,nombre,status,orden,total,fecha,n_presupuesto)
...
<html lang="es">
	<head>
		<meta charset="UTF-8" />
		<title>Guardar - Factura JJCORDERO</title>
