<?php
	...
	$registro=mysql_query("insert into jjfactura(factura, codigo, nombre_emp, mail, nombre, tipo, costo_m, materiales, costo_mat, orden, precio, status)
	...
	echo "<a href='/serbar/jjcordero/facturacion'>volver</a>";
?>