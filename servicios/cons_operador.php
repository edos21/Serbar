...
//consulta de los servicios tomando como filtro la cedula del operador que presto el servicio
	...
	$registro=mysql_query("select * from solicitud where cedula='$_REQUEST[cedula]'",$conexion) or
	die("error en select: ".mysql_error());
	$registro2=mysql_query("select * from solicitud where cedula='$_REQUEST[cedula]'",$conexion) or
	die("error en select: ".mysql_error());
?>
<!DOCTYPE html>
<html lang="es">
