...
<html lang="es">
	...
	<body>
		...
		if ($reg=mysql_fetch_array($registro)) {
			$regisservicio=mysql_query("select * from servicios where n_presupuesto='$reg[n_presupuesto]'",$conexion) or
			die("error en select: ".mysql_error());
			$regispresupuesto=mysql_query("select * from presupuesto where n_presupuesto='$reg[n_presupuesto]'",$conexion) or
			die("error en select: ".mysql_error());
		?>
		<div>
